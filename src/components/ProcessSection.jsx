  ...
  return (
    <section className="py-12 sm:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-6 text-sm text-neutral-300">Gesamtzeit: ~5 Minuten statt 2–4 Stunden</p>

        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="rounded-lg border border-white/10 p-5 bg-white/5">
            <h3 className="text-white font-medium">Ihre Eingabe (2 Minuten):</h3>
          ...
          <div className="rounded-lg border border-white/10 p-5 bg-white/5">
            <h3 className="text-white font-medium">Generiertes Ergebnis (30 Sekunden):</h3>
            <div className="mt-3 rounded-md bg-neutral-900/80 border border-white/10 p-4 text-sm text-neutral-200">
              ...
              <ul className="mt-3 text-neutral-300 space-y-1">
